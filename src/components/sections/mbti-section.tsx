                        ...
                        <div className="relative z-10 flex flex-col items-center">
                          ...
                          <button
                            onClick={() => {
                              ...
                              else if (result.methodType === 'direct') window.open('https://teform.kan-da.com/', '_blank', 'noopener,noreferrer');
                            }}
                            ...
                            return (
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  if (type === 'direct') window.open('https://teform.kan-da.com/', '_blank', 'noopener,noreferrer');
                                }}
